...
App = {
  ...
  loadContract: async () => {
    const contract = await $.getJSON('Counter.json')
    console.log('contract', contract)
    App.contracts.Counter = TruffleContract(contract)
  ...
  async render() {
    ...
    // 加载智能合约
    const contract = await App.contracts.Counter.deployed()
  ...
  set: async () => {
    ...
    await App.contractInstance.increase({from: App.account})
